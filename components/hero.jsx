      ...
      <div className="text-center z-10 px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            Professional image editing powered by AI. Create stunning visuals
            with ease, crop, adjust colours, remove backgrounds and enhance your
            images with our AI-powered image editor.
          </p>
