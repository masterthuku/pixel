  ...
  return (
    <>
          ...
          <div className="space-y-6">
            {isFree && currentProjectCount >= 2 && (
              <Alert className={"bg-amber-500/10 border-amber-500/20"}>
                <Crown className="h-5 w-5 teaxt-amber-400" />
                <AlertDescription className={"text-amber-300/80"}>
                  <div className="font-semibold text-amber-400 mb-1">
                    ...
                    {currentProjectCount === 2
                      ? "This is your last free project. Upgrade to Pro to create more projects."
                      : "Free users can only create 3 projects. Upgrade to Pro to create more projects."}
                  </div>
                </AlertDescription>
              </Alert>
            )}
            ...
            {!selectedFile ? (
              ...
              >
                ...
                <p className="text-sm text-white/50">
                  Supports PNG, JPEG, WEBP, and GIF. Max size: 20MB
                </p>
              </div>
            ) : (
              <div className="space-y-6">
      ...
      <UpgradeModal
        ...
        reason="Free plan is limited to 3 projects. Upgrade to Pro for unlimited projects and access to all AI tools."
      />
    </>
  );
};
